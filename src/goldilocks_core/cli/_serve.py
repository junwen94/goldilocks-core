...
epic. No ``--static-root`` flag anymore: the Workbench static-file
mount is v2 epic 12 (#12)'s scope, not wired back up here (see
``server/http.py``'s own docstring). P7's "optional deps imported
